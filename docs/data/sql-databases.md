...
See [part 9 of the tutorial](../intro/tutorial09.md) for an introduction.

## Storing and retrieving data in SQLite3

See [Using SQL DBs](../developers/using-sql-dbs.rst) in the Developers Guide
    
## Mapping from a LinkML model to SQL Schemas

The [SQL DDL Generator](../generators/sqlddl.rst) can be used to generate SQL DDL (`CREATE TABLE` statements) from a schema.
...
* When handling [inheritance](../schemas/inheritance.md):
...
The [SQLAlchemy Generator](../generators/sqlalchemy.rst) will generate a Python ORM.
...
For Java you can do this by tuning the Jinja2 templates that are generated, see [Java Generation](../generators/java.rst)
